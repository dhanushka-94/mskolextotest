    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-4">
            <ol class="flex items-center space-x-2 text-xs text-gray-500">
                <li><a href="{{ route('home') }}" class="hover:text-[#f59e0b] transition-colors">Home</a></li>
                <li><span class="mx-1">/</span></li>
                <li><a href="{{ route('categories.index') }}" class="hover:text-[#f59e0b] transition-colors">Categories</a></li>
                <li><span class="mx-1">/</span></li>
                <li class="text-[#f59e0b] font-medium">{{ $category->name }}</li>
            </ol>
        </nav>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-400">{{ $products->total() }} products available</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex flex-col">
                                    @if($product->is_on_sale)
                                        ...
                                        <span class="text-lg font-bold text-[#f59e0b]">LKR {{ number_format($product->final_price, 2) }}</span>
                                    @else
                                        @if($product->price > 0 && $product->final_price > 0)
                                            <span class="text-lg font-bold text-white">LKR {{ number_format($product->final_price, 2) }}</span>
                                        @else
