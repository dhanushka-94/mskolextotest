...
<section class="py-16 bg-black">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-[#1a1a1c] border border-gray-800 rounded-xl overflow-hidden">
            <!-- Map Placeholder -->
            <div class="h-96 bg-gray-800/50 flex items-center justify-center relative">
                <div class="text-center">
                    <div class="w-20 h-20 bg-[#f59e0b]/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                        <svg class="w-10 h-10 text-[#f59e0b]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-white mb-2">MSK COMPUTERS Location</h3>
                    <p class="text-gray-400 mb-4">No.296/3D, Delpe Junction, Ragama, Sri Lanka</p>
                    <button class="bg-[#f59e0b] text-black font-bold px-6 py-3 rounded-lg hover:bg-[#d97706] transition-colors">
                        Get Directions
                    </button>
                </div>
                
                <!-- You can replace this placeholder with an actual Google Maps embed or other map service -->
