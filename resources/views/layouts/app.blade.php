<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark" data-catalog-source="{{ $catalogSource ?? 'msk' }}">
<head>
    <meta charset="utf-8">
     ...
     <header class="bg-black border-b border-gray-800 sticky top-0 z-[9999] shadow-lg navigation-header">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="hidden md:flex items-center justify-center space-x-4 lg:space-x-8 h-12">
                ...
                <!-- Categories Dropdown -->
                <div class="relative group">
                    <button class="text-gray-300 hover:text-primary-400 transition-colors text-sm font-medium flex items-center whitespace-nowrap {{ $mskCatalogNavActive ? 'text-primary-400' : '' }}" id="categories-dropdown-trigger">
                        Categories
