                    ...
                    <form action="{{ $paymentData['checkout_url'] }}" method="POST" id="webxpay-form" class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="customer_full_name" value="{{ $order->customer_name }}" 
                                ...
                                <input type="hidden" name="first_name" value="{{ $paymentData['first_name'] }}" id="webxpay_first_name">
                                <input type="hidden" name="last_name" value="{{ $paymentData['last_name'] }}" id="webxpay_last_name">
                            </div>
