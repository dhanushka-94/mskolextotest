...
<div class="space-y-8">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="text-right text-sm text-gray-400">
            <p><?php echo e(\Carbon\Carbon::now()->setTimezone('Asia/Colombo')->format('l, F j, Y')); ?></p>
            <p><?php echo e(\Carbon\Carbon::now()->setTimezone('Asia/Colombo')->format('g:i A')); ?> <span class="text-xs text-gray-500">LKT</span></p>
        </div>
    </div>
        ...
        <div class="bg-gradient-to-br from-primary-500/10 to-primary-600/5 border border-primary-500/20 rounded-xl p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-gray-300"><?php echo e(\Carbon\Carbon::today()->setTimezone('Asia/Colombo')->format('F j, Y')); ?></p>
                </div>
                <div class="text-right">
                    <div class="text-3xl font-bold text-primary-400"><?php echo e($stats['today_orders']); ?></div>
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="text-center">
                    <div class="text-lg font-semibold text-white"><?php echo e($stats['today_pending']); ?></div>
                    <div class="text-xs text-yellow-400">Pending</div>
                </div>
                <div class="text-center">
                    <div class="text-lg font-semibold text-white"><?php echo e($stats['today_orders'] - $stats['today_pending']); ?></div>
                    <div class="text-xs text-green-400">Processed</div>
                </div>
                <div class="text-center">
                    <div class="text-lg font-semibold text-white">LKR <?php echo e(number_format($stats['today_revenue'], 0)); ?></div>
                    <div class="text-xs text-primary-400">Revenue</div>
                </div>
            </div>
            
            <div class="flex gap-2">
                <a href="<?php echo e(route('admin.orders.index', ['filter' => 'today'])); ?>" 
                ...
                <?php if($stats['today_pending'] > 0): ?>
                <a href="<?php echo e(route('admin.orders.index', ['filter' => 'today', 'status' => 'pending'])); ?>" 
                   class="bg-yellow-500/20 hover:bg-yellow-500/30 text-yellow-400 px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                    <?php echo e($stats['today_pending']); ?> Pending
                </a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-gray-500/10 to-gray-600/5 border border-gray-500/20 rounded-xl p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-gray-300"><?php echo e(\Carbon\Carbon::yesterday()->setTimezone('Asia/Colombo')->format('F j, Y')); ?></p>
                </div>
                <div class="text-right">
                    <div class="text-3xl font-bold text-gray-300"><?php echo e($stats['yesterday_orders']); ?></div>
                    <div class="text-sm text-gray-400">Orders</div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="text-center">
                    <div class="text-lg font-semibold text-white"><?php echo e($stats['yesterday_pending']); ?></div>
                    <div class="text-xs text-yellow-400">Pending</div>
                </div>
                <div class="text-center">
                    <div class="text-lg font-semibold text-white"><?php echo e($stats['yesterday_orders'] - $stats['yesterday_pending']); ?></div>
                    <div class="text-xs text-green-400">Processed</div>
                </div>
                <div class="text-center">
                    <div class="text-lg font-semibold text-white">LKR <?php echo e(number_format($stats['yesterday_revenue'], 0)); ?></div>
                    <div class="text-xs text-gray-400">Revenue</div>
                </div>
            </div>
            
            <div class="flex gap-2">
                <a href="<?php echo e(route('admin.orders.index', ['filter' => 'yesterday'])); ?>" 
                ...
                <?php if($stats['yesterday_pending'] > 0): ?>
                <a href="<?php echo e(route('admin.orders.index', ['filter' => 'yesterday', 'status' => 'pending'])); ?>" 
                   class="bg-yellow-500/20 hover:bg-yellow-500/30 text-yellow-400 px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                    <?php echo e($stats['yesterday_pending']); ?> Pending
                </a>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-800">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-medium text-white">Today's Orders (<?php echo e($todayOrders->count()); ?>)</h3>
                    <a href="<?php echo e(route('admin.orders.index', ['filter' => 'today'])); ?>" 
            ...
            <?php if($todayOrders->count() > 0): ?>
                <div class="divide-y divide-gray-800 max-h-96 overflow-y-auto">
                    <?php $__currentLoopData = $todayOrders->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="px-6 py-4 hover:bg-gray-800/30 transition-colors">
                            <div class="flex items-center justify-between mb-2">
                                <div>
                                    <p class="text-sm font-medium text-white">
                                        <a href="<?php echo e(route('admin.orders.show', $order)); ?>" class="hover:text-primary-400">
                                            #<?php echo e($order->order_number ?? $order->id); ?>

                                        </a>
                                    </p>
                                    <p class="text-sm text-gray-400"><?php echo e($order->customer_name ?? $order->customer_email); ?></p>
                                </div>
                                <div class="text-right">
                                    <p class="text-sm font-medium text-white">LKR <?php echo e(number_format($order->total_amount, 2)); ?></p>
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium 
                                        <?php if($order->status == 'pending'): ?> bg-yellow-500/20 text-yellow-400
                                        <?php elseif($order->status == 'confirmed'): ?> bg-blue-500/20 text-blue-400
                                        <?php elseif($order->status == 'processing'): ?> bg-purple-500/20 text-purple-400
                                        <?php elseif($order->status == 'shipped'): ?> bg-indigo-500/20 text-indigo-400
                                        <?php elseif($order->status == 'delivered'): ?> bg-green-500/20 text-green-400
                                        <?php elseif($order->status == 'cancelled'): ?> bg-red-500/20 text-red-400
                            ...
                            <div class="flex items-center justify-between text-xs text-gray-500">
                                <span><?php echo e($order->orderItems->count() ?? 0); ?> items</span>
                                <span><?php echo e($order->created_at->setTimezone('Asia/Colombo')->format('g:i A')); ?></span>
                            </div>
                        </div>
        ...
        <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-800">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-medium text-white">Yesterday's Orders (<?php echo e($yesterdayOrders->count()); ?>)</h3>
                    <a href="<?php echo e(route('admin.orders.index', ['filter' => 'yesterday'])); ?>" 
            ...
            <?php if($yesterdayOrders->count() > 0): ?>
                <div class="divide-y divide-gray-800 max-h-96 overflow-y-auto">
                    <?php $__currentLoopData = $yesterdayOrders->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="px-6 py-4 hover:bg-gray-800/30 transition-colors">
                            <div class="flex items-center justify-between mb-2">
                                <div>
                                    <p class="text-sm font-medium text-white">
                                        <a href="<?php echo e(route('admin.orders.show', $order)); ?>" class="hover:text-gray-300">
                                            #<?php echo e($order->order_number ?? $order->id); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <!-- Quick Actions -->
        <?php echo $__env->make('components.dashboard-quick-actions', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
                ...
                <?php $__currentLoopData = $recentCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="px-6 py-4 hover:bg-gray-800/30 transition-colors">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                <p class="text-sm text-gray-400"><?php echo e($customer->created_at->setTimezone('Asia/Colombo')->format('M d, Y')); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
