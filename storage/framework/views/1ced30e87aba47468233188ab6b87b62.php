...
<?php $__env->startSection('title', 'Account Settings - MSK COMPUTERS'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('user.dashboard')); ?>" class="bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-800/30 rounded-lg">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="email_notifications" value="1" class="sr-only peer" 
                                           <?php echo e((old('email_notifications', json_decode($user->settings ?? '{}', true)['email_notifications'] ?? true)) ? 'checked' : ''); ?>>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-800/30 rounded-lg">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="sms_notifications" value="1" class="sr-only peer"
                                           <?php echo e((old('sms_notifications', json_decode($user->settings ?? '{}', true)['sms_notifications'] ?? true)) ? 'checked' : ''); ?>>
                                    <div class="w-11 h-6 bg-gray-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-800/30 rounded-lg">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="marketing_notifications" value="1" class="sr-only peer"
                                           <?php echo e((old('marketing_notifications', json_decode($user->settings ?? '{}', true)['marketing_notifications'] ?? false)) ? 'checked' : ''); ?>>
                                    <div class="w-11 h-6 bg-gray-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select id="language" name="language" class="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary-500">
                                    <option value="en" <?php echo e((old('language', json_decode($user->settings ?? '{}', true)['language'] ?? 'en') == 'en') ? 'selected' : ''); ?>>English</option>
                                    <option value="si" <?php echo e((old('language', json_decode($user->settings ?? '{}', true)['language'] ?? 'en') == 'si') ? 'selected' : ''); ?>>Sinhala</option>
                                    <option value="ta" <?php echo e((old('language', json_decode($user->settings ?? '{}', true)['language'] ?? 'en') == 'ta') ? 'selected' : ''); ?>>Tamil</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="currency" name="currency" class="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary-500">
                                    <option value="LKR" <?php echo e((old('currency', json_decode($user->settings ?? '{}', true)['currency'] ?? 'LKR') == 'LKR') ? 'selected' : ''); ?>>Sri Lankan Rupee (LKR)</option>
                                    <option value="USD" <?php echo e((old('currency', json_decode($user->settings ?? '{}', true)['currency'] ?? 'LKR') == 'USD') ? 'selected' : ''); ?>>US Dollar (USD)</option>
                                </select>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select id="timezone" name="timezone" class="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary-500">
                                    <option value="Asia/Colombo" <?php echo e((old('timezone', json_decode($user->settings ?? '{}', true)['timezone'] ?? 'Asia/Colombo') == 'Asia/Colombo') ? 'selected' : ''); ?>>Asia/Colombo (GMT+5:30)</option>
                                    <option value="UTC" <?php echo e((old('timezone', json_decode($user->settings ?? '{}', true)['timezone'] ?? 'Asia/Colombo') == 'UTC') ? 'selected' : ''); ?>>UTC (GMT+0:00)</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views\user\settings.blade.php ENDPATH**/ ?>