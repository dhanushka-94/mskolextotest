     ...
     <header class="bg-black border-b border-gray-800 sticky top-0 z-[9999] shadow-lg navigation-header">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between h-24 border-b border-gray-800/50">
                ...
                <div class="flex-1 max-w-2xl mx-8 hidden md:block">
                    <form action="<?php echo e(route('products.search')); ?>" method="GET" class="relative" id="search-form">
            ...
            <div class="flex items-center justify-center space-x-4 lg:space-x-8 h-12">
                ...
                <!-- Categories Dropdown -->
                <div class="relative group">
                    <a href="<?php echo e(route('categories.index')); ?>" class="text-gray-300 hover:text-primary-400 transition-colors text-sm font-medium flex items-center whitespace-nowrap <?php echo e(request()->routeIs('categories.*') ? 'text-primary-400' : ''); ?>">
                        Categories
        ...
        <div class="md:hidden hidden mobile-menu" id="mobile-menu">
            <div class="px-4 pt-4 pb-3 space-y-3 bg-black border-t border-gray-800 max-h-96 overflow-y-auto">
                ...
                <!-- Main Navigation -->
                <a href="<?php echo e(route('home')); ?>" class="block py-2 text-gray-300 hover:text-primary-400 <?php echo e(request()->routeIs('home') ? 'text-primary-400' : ''); ?>">Home</a>
                ...
                <div class="space-y-2">
                    ...
                    <?php $__currentLoopData = $menuCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="ml-2 space-y-1">
                            <a href="<?php echo e(route('categories.show', $category->slug ?: $category->id)); ?>" class="block py-1 text-gray-300 hover:text-primary-400 text-sm">
                                <?php echo e($category->name); ?> (<?php echo e($category->products_count); ?>)
                            </a>
                            <?php if($category->subcategories->count() > 0): ?>
                                <div class="ml-4 space-y-1">
                                    <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('categories.show', $subcategory->slug ?: $subcategory->id)); ?>" class="block py-1 text-gray-400 hover:text-primary-400 text-sm">
                                            <?php echo e($subcategory->name); ?> (<?php echo e($subcategory->subcategory_products_count ?? 0); ?>)
                                        </a>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php endif; ?>
                ...
                <a href="<?php echo e(route('promotions.index')); ?>" class="block py-2 text-gray-300 hover:text-primary-400 <?php echo e(request()->routeIs('promotions.*') ? 'text-primary-400' : ''); ?>">Promotions</a>
                <a href="<?php echo e(route('orders.track')); ?>" class="block py-2 text-gray-300 hover:text-primary-400 <?php echo e(request()->routeIs('orders.track') ? 'text-primary-400' : ''); ?>">Track Order</a>
                <a href="<?php echo e(route('services.index')); ?>" class="block py-2 text-gray-300 hover:text-primary-400 <?php echo e(request()->routeIs('services.*') ? 'text-primary-400' : ''); ?>">Service Center</a>
                <a href="<?php echo e(route('bank-details.index')); ?>" class="block py-2 text-gray-300 hover:text-primary-400 <?php echo e(request()->routeIs('bank-details.*') ? 'text-primary-400' : ''); ?>">Bank Details</a>
                <a href="<?php echo e(route('about-us.index')); ?>" class="block py-2 text-gray-300 hover:text-primary-400 <?php echo e(request()->routeIs('about-us.*') ? 'text-primary-400' : ''); ?>">About Us</a>
                <a href="<?php echo e(route('contact-us.index')); ?>" class="block py-2 text-gray-300 hover:text-primary-400 <?php echo e(request()->routeIs('contact-us.*') ? 'text-primary-400' : ''); ?>">Contact Us</a>
                <a href="<?php echo e(route('e-services.index')); ?>" class="block py-2 text-gray-300 hover:text-primary-400 <?php echo e(request()->routeIs('e-services.*') ? 'text-primary-400' : ''); ?>">E-Services</a>
