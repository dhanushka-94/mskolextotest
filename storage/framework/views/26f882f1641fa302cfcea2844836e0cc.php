    ...
    <nav class="bg-black border-b border-gray-800 sticky top-0 z-50">
            ...
            <div class="flex justify-between h-18">
                ...
                <div class="flex items-center space-x-10 lg:space-x-12 xl:space-x-16">
                    <div class="flex items-center space-x-4 py-3">
                        <img src="<?php echo e(asset('msk-computers-logo-color.png')); ?>" alt="MSK Computers" class="h-10 w-10">
                        <div>
                    ...
                    <div class="hidden md:flex md:space-x-4 lg:space-x-6 xl:space-x-8 2xl:space-x-10">
                        ...
                        <div class="flex space-x-2">
                            <a href="<?php echo e(route('admin.dashboard')); ?>" 
                               class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-[#f59e0b] text-black shadow-lg scale-105' : 'text-gray-300 hover:text-white hover:bg-gray-700/70 hover:scale-105'); ?>">
                            ...
                            <a href="<?php echo e(route('admin.orders.index')); ?>" 
                               class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-[#f59e0b] text-black shadow-lg scale-105' : 'text-gray-300 hover:text-white hover:bg-gray-700/70 hover:scale-105'); ?>">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex space-x-2">
                            <div class="relative group">
                                <button class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.users.*') ? 'bg-[#f59e0b] text-black shadow-lg' : 'text-gray-300 hover:text-white hover:bg-gray-700/70'); ?>">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="<?php echo e(route('admin.transactions.index')); ?>" 
                               class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.transactions.*') ? 'bg-[#f59e0b] text-black shadow-lg scale-105' : 'text-gray-300 hover:text-white hover:bg-gray-700/70 hover:scale-105'); ?>">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex space-x-2">
                            <a href="<?php echo e(route('admin.analytics')); ?>" 
                               class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.analytics') ? 'bg-[#f59e0b] text-black shadow-lg scale-105' : 'text-gray-300 hover:text-white hover:bg-gray-700/70 hover:scale-105'); ?>">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- Tools Dropdown -->
                            <div class="relative group">
                                <button class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('admin.activity-logs.*') || request()->routeIs('admin.sitemap.*') ? 'bg-[#f59e0b] text-black shadow-lg' : 'text-gray-300 hover:text-white hover:bg-gray-700/70'); ?>">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="md:hidden hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 bg-gray-900 border-t border-gray-700">
                <a href="<?php echo e(route('admin.dashboard')); ?>" 
                   class="flex items-center px-3 py-2 text-base font-medium rounded-md transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-[#f59e0b] text-black' : 'text-gray-300 hover:text-white hover:bg-gray-700'); ?>">
                ...
                <a href="<?php echo e(route('admin.orders.index')); ?>" 
                   class="flex items-center px-3 py-2 text-base font-medium rounded-md transition-colors <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-[#f59e0b] text-black' : 'text-gray-300 hover:text-white hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                    </svg>
                    Orders
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>" 
                   class="flex items-center px-3 py-2 text-base font-medium rounded-md transition-colors <?php echo e(request()->routeIs('admin.users.*') ? 'bg-[#f59e0b] text-black' : 'text-gray-300 hover:text-white hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"/>
                    </svg>
                    All Users
                ...
                <a href="<?php echo e(route('admin.users.index', ['role' => 'customer'])); ?>" 
                   class="flex items-center px-3 py-2 text-base font-medium rounded-md transition-colors <?php echo e(request()->get('role') == 'customer' ? 'bg-[#f59e0b] text-black' : 'text-gray-300 hover:text-white hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                    Customers
                ...
                <a href="<?php echo e(route('admin.transactions.index')); ?>" 
                   class="flex items-center px-3 py-2 text-base font-medium rounded-md transition-colors <?php echo e(request()->routeIs('admin.transactions.*') ? 'bg-[#f59e0b] text-black' : 'text-gray-300 hover:text-white hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                    Transactions
                ...
                <a href="<?php echo e(route('admin.analytics')); ?>" 
                   class="flex items-center px-3 py-2 text-base font-medium rounded-md transition-colors <?php echo e(request()->routeIs('admin.analytics') ? 'bg-[#f59e0b] text-black' : 'text-gray-300 hover:text-white hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
                    Analytics
                ...
                <a href="<?php echo e(route('admin.activity-logs.index')); ?>" 
                   class="flex items-center px-3 py-2 text-base font-medium rounded-md transition-colors <?php echo e(request()->routeIs('admin.activity-logs.*') ? 'bg-[#f59e0b] text-black' : 'text-gray-300 hover:text-white hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    Activity Logs
                ...
                <a href="<?php echo e(route('admin.sitemap.index')); ?>" 
                   class="flex items-center px-3 py-2 text-base font-medium rounded-md transition-colors <?php echo e(request()->routeIs('admin.sitemap.*') ? 'bg-[#f59e0b] text-black' : 'text-gray-300 hover:text-white hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>
                    </svg>
                    Sitemap Management
                ...
                <div class="border-t border-gray-700 pt-4 mt-4">
                    <div class="flex items-center px-3 py-2">
                        <img class="w-8 h-8 rounded-full mr-3" src="<?php echo e(Auth::user()->avatar_url); ?>" alt="<?php echo e(Auth::user()->name); ?>">
                        <div>
                            <div class="text-sm font-medium text-white"><?php echo e(Auth::user()->name); ?></div>
                            <div class="text-xs text-gray-400">Administrator</div>
                        </div>
                ...
                <div class="text-center">
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-2 text-sm text-gray-400">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <span class="text-xs text-gray-500"><?php echo e(date('Y')); ?></span>
                        </div>
                    </div>
