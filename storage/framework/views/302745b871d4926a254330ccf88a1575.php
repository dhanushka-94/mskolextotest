...
<?php $__env->startSection('title', 'Terms of Service - MSK Computers'); ?>
...
<div class="min-h-screen bg-dark-900 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 text-lg">Last updated: <?php echo e(date('F d, Y')); ?></p>
        </div>
        ...
        <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-8">
            <div class="prose prose-invert max-w-none">
                ...
                <p class="text-gray-300 mb-6">
                    ...
                    <a href="<?php echo e(route('privacy-policy')); ?>" class="text-primary-400 hover:text-primary-300 underline">Privacy Policy</a>, 
                ...
                <div class="text-gray-300 mb-6">
                    ...
                    <div class="bg-dark-800 rounded-lg p-4">
                        ...
                        <p>Website: <a href="<?php echo e(url('/')); ?>" class="text-primary-400 hover:text-primary-300"><?php echo e(url('/')); ?></a></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views\legal\terms-of-service.blade.php ENDPATH**/ ?>