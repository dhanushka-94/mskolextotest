...
<?php $__env->startSection('description', 'The requested page could not be found, but here are some suggestions.'); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed mb-4">
                We couldn't find the page you're looking for: <span class="text-[#f59e0b] font-mono"><?php echo e($path); ?></span>
            </p>
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
            <!-- Similar Categories -->
            <?php if($similarCategories->count() > 0): ?>
            <div class="bg-[#2c2c2e]/50 rounded-2xl p-6 border border-gray-800/30">
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $similarCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('categories.show', $category->slug ?: $category->id)); ?>" 
                       class="block p-3 rounded-lg bg-[#3c3c3e]/50 hover:bg-[#4c4c4e]/50 transition-colors group">
                        ...
                        <div class="text-sm text-gray-500 font-mono">/<?php echo e($category->slug); ?></div>
                        <?php endif; ?>
                    </a>
                ...
                <div class="space-y-3">
                    ...
                    <a href="<?php echo e(route('products.show', ['category' => $product->category->slug ?: $product->category->id, 'product' => $product->slug])); ?>" 
                       class="block p-3 rounded-lg bg-[#3c3c3e]/50 hover:bg-[#4c4c4e]/50 transition-colors group">
                        ...
                        <div class="text-sm text-gray-500">in <?php echo e($product->category->name); ?></div>
                        <?php if($product->price > 0): ?>
                        <div class="text-sm text-[#f59e0b] font-semibold">LKR <?php echo e(number_format($product->price, 2)); ?></div>
                        <?php endif; ?>
                    </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="text-center space-y-4">
            ...
            <div class="mt-8 p-6 bg-[#2c2c2e]/30 rounded-xl border border-gray-800/20">
                ...
                <form action="<?php echo e(route('products.search')); ?>" method="GET" class="flex gap-3">
                    <input type="text" 
                           name="q" 
                           placeholder="Search for products..." 
                           value="<?php echo e($requestedProduct ? str_replace('-', ' ', $requestedProduct) : ''); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views\errors\suggest-alternatives.blade.php ENDPATH**/ ?>