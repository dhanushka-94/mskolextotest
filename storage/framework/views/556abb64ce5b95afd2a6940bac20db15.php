                ...
                <div class="lg:col-span-2">
                    <div class="bg-[#1a1a1c] rounded-lg border border-gray-800 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-800">
                            <h2 class="text-lg font-semibold text-white">Cart Items (<?php echo e($cartItems->sum('quantity')); ?>)</h2>
                        </div>
                                    ...
                                    <div class="flex items-start space-x-4">
                                        ...
                                        <div class="flex-grow">
                                            ...
                                            <div class="flex items-center space-x-3 mt-3">
                                                ...
                                                <span class="text-gray-500 text-sm">(<?php echo e(number_format($item->product->stock_quantity, 0)); ?> available)</span>
                                            </div>
                                        </div>
