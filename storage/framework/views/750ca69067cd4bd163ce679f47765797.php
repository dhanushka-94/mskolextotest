<?php $__env->startSection('title', 'About Us - MSK COMPUTERS | Serving Sri Lanka Since 2008'); ?>
<?php $__env->startSection('description', 'Learn about MSK COMPUTERS - Sri Lanka\'s trusted computer retailer since 2008. Quality products, expert service, and commitment to excellence.'); ?>
<?php $__env->startSection('keywords', 'about MSK Computers, computer company Sri Lanka, warranty, delivery service, after sales service, computer retailer'); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="group bg-[#1a1a1c] rounded-xl border border-gray-800 overflow-hidden hover:border-[#f59e0b]/50 transition-all duration-300">
                <div class="aspect-square bg-white/5 overflow-hidden">
                    <img src="<?php echo e(asset('images/awards/awards00 (1).JPG')); ?>" 
            ...
            <div class="group bg-[#1a1a1c] rounded-xl border border-gray-800 overflow-hidden hover:border-[#f59e0b]/50 transition-all duration-300">
                <div class="aspect-square bg-white/5 overflow-hidden">
                    <img src="<?php echo e(asset('images/awards/awards00 (2).JPG')); ?>" 
                         alt="MSK Computers Award" 
                         class="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 p-4">
                </div>
            </div>
            ...
            <div class="group bg-[#1a1a1c] rounded-xl border border-gray-800 overflow-hidden hover:border-[#f59e0b]/50 transition-all duration-300">
                <div class="aspect-square bg-white/5 overflow-hidden">
                    <img src="<?php echo e(asset('images/awards/awards00 (3).JPG')); ?>" 
                         alt="MSK Computers Award" 
                         class="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 p-4">
                </div>
            </div>
            ...
            <div class="group bg-[#1a1a1c] rounded-xl border border-gray-800 overflow-hidden hover:border-[#f59e0b]/50 transition-all duration-300">
                <div class="aspect-square bg-white/5 overflow-hidden">
                    <img src="<?php echo e(asset('images/awards/awards00 (4).JPG')); ?>" 
                         alt="MSK Computers Award" 
                         class="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 p-4">
                </div>
            </div>
            ...
            <div class="group bg-[#1a1a1c] rounded-xl border border-gray-800 overflow-hidden hover:border-[#f59e0b]/50 transition-all duration-300">
                <div class="aspect-square bg-white/5 overflow-hidden">
                    <img src="<?php echo e(asset('images/awards/awards00 (5).JPG')); ?>" 
                         alt="MSK Computers Award" 
                         class="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 p-4">
                </div>
            </div>
            ...
            <div class="group bg-[#1a1a1c] rounded-xl border border-gray-800 overflow-hidden hover:border-[#f59e0b]/50 transition-all duration-300">
                <div class="aspect-square bg-white/5 overflow-hidden">
                    <img src="<?php echo e(asset('images/awards/awards00 (6).JPG')); ?>" 
                         alt="MSK Computers Award" 
                         class="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 p-4">
                </div>
            </div>
            ...
            <div class="group bg-[#1a1a1c] rounded-xl border border-gray-800 overflow-hidden hover:border-[#f59e0b]/50 transition-all duration-300">
                <div class="aspect-square bg-white/5 overflow-hidden">
                    <img src="<?php echo e(asset('images/awards/awards00 (7).JPG')); ?>" 
                         alt="MSK Computers Award" 
                         class="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 p-4">
                </div>
            </div>
            ...
            <div class="group bg-[#1a1a1c] rounded-xl border border-gray-800 overflow-hidden hover:border-[#f59e0b]/50 transition-all duration-300">
                <div class="aspect-square bg-white/5 overflow-hidden">
                    <img src="<?php echo e(asset('images/awards/awards00 (8).JPG')); ?>" 
                         alt="MSK Computers Award" 
                         class="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 p-4">
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views\about-us.blade.php ENDPATH**/ ?>