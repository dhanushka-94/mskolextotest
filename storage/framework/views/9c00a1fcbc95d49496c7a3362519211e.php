<?php $__env->startSection('title', 'Register - MSK COMPUTERS'); ?>
<?php $__env->startSection('description', 'Create your MSK Computers account to track orders, save addresses, and enjoy personalized shopping experience.'); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="name" name="name" type="text" autocomplete="name" required 
                                   ...
                                   class="w-full pl-10 pr-4 py-3 bg-[#0f0f0f]/50 backdrop-blur-sm border border-gray-600/50 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#f59e0b]/50 focus:border-[#f59e0b] transition-all duration-300 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                ...
                <div>
                    ...
                    <input id="email" name="email" type="email" autocomplete="email" required 
                           ...
                           class="w-full px-4 py-3 bg-[#1a1a1c] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#f59e0b] focus:border-transparent transition-all duration-300 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                ...
                <div>
                    ...
                    <input id="phone" name="phone" type="tel" autocomplete="tel" 
                           ...
                           class="w-full px-4 py-3 bg-[#1a1a1c] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#f59e0b] focus:border-transparent transition-all duration-300 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" autocomplete="new-password" required 
                           class="w-full px-4 py-3 bg-[#1a1a1c] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#f59e0b] focus:border-transparent transition-all duration-300 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
            ...
            <div class="flex items-start">
                <div class="flex items-center h-5">
                    <input id="terms" name="terms" type="checkbox" required
                           class="h-4 w-4 bg-[#1a1a1c] border-gray-700 rounded text-[#f59e0b] focus:ring-[#f59e0b] focus:ring-offset-gray-900 <?php $__errorArgs = ['terms'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
            ...
            <div class="text-center">
                <p class="text-gray-400">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-[#f59e0b] hover:text-[#d97706] font-medium transition-colors">Sign in here</a>
                </p>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views\auth\register.blade.php ENDPATH**/ ?>