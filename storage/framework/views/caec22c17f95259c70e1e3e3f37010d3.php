...
<?php $__env->startSection('title', 'Warranty Certificate and Terms - MSK COMPUTERS'); ?>
<?php $__env->startSection('description', 'Comprehensive warranty coverage with clear terms and conditions for your peace of mind at MSK COMPUTERS. වගකීම් සහතිකය හා අදාළ කොන්දේසි'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 bg-[#1c1c1e] border border-gray-800 rounded-xl p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('contact-us.index')); ?>" class="bg-[#f59e0b] hover:bg-[#d97706] text-black px-8 py-3 rounded-lg font-semibold transition-colors">
                    Contact Support
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views\warranty.blade.php ENDPATH**/ ?>