...
<?php $__env->startSection('title', 'My Addresses - MSK COMPUTERS'); ?>
<?php $__env->startSection('description', 'Manage your delivery addresses for faster checkout at MSK Computers.'); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="contact_name" 
                               name="contact_name" 
                               value="<?php echo e(old('contact_name', Auth::user()->name)); ?>" 
                               required
                               class="w-full px-4 py-3 bg-[#0f0f0f] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#f59e0b] focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" 
                               id="contact_phone" 
                               name="contact_phone" 
                               value="<?php echo e(old('contact_phone', Auth::user()->phone)); ?>" 
                               required
                               class="w-full px-4 py-3 bg-[#0f0f0f] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#f59e0b] focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="country" 
                               name="country" 
                               value="<?php echo e(old('country', 'Sri Lanka')); ?>"
                               class="w-full px-4 py-3 bg-[#0f0f0f] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#f59e0b] focus:border-transparent">
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-[#1a1a1c] to-[#2a2a2c] rounded-xl border border-gray-800 p-6 relative">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                <h3 class="text-lg font-medium text-white"><?php echo e($address->name); ?></h3>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                    <?php echo e($address->type === 'shipping' ? 'bg-blue-900/30 text-blue-300 border border-blue-800' : 'bg-purple-900/30 text-purple-300 border border-purple-800'); ?>">
                            ...
                            <!-- Actions Dropdown -->
                            <div class="relative">
                                <button onclick="toggleDropdown('dropdown-<?php echo e($address->id); ?>')" 
                                ...
                                <div id="dropdown-<?php echo e($address->id); ?>" class="hidden absolute right-0 mt-2 w-48 bg-black border border-gray-800 rounded-lg shadow-xl z-10">
                                    <div class="py-1">
                                        <?php if(!$address->is_default): ?>
                                            <form action="<?php echo e(route('user.addresses.default', $address)); ?>" method="POST" class="block">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <?php endif; ?>
                                        <button onclick="editAddress(<?php echo e($address->id); ?>)" class="flex items-center w-full px-4 py-2 text-sm text-gray-300 hover:bg-gray-800 hover:text-[#f59e0b] transition-colors">
                                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                            Edit
                                        </button>
                                        <form action="<?php echo e(route('user.addresses.delete', $address)); ?>" method="POST" class="block">
                                            <?php echo csrf_field(); ?>
                        ...
                        <!-- Address Details -->
                        <div class="space-y-2">
                            <p class="text-white font-medium"><?php echo e($address->contact_name); ?></p>
                            <p class="text-gray-300"><?php echo e($address->contact_phone); ?></p>
                            <div class="text-gray-300 text-sm" style="white-space: pre-line;"><?php echo e($address->full_address); ?></div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\MSK\MSKMSV3\resources\views\user\addresses.blade.php ENDPATH**/ ?>